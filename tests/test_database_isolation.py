...
def test_flask_app_factory_accepts_isolated_database_and_data_dir(tmp_path):
    ...
    try:
        ...
        assert get_upload_path("scan.png") == data_dir / "uploads" / "scan.png"

        _create_document(database.get_database_context(), "factory.png")
        assert _count_documents(database.get_database_context()) == 1
